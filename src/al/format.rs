...
impl ExtALawFormat {
	pub fn into_raw(self, ctx: Option<&Context>) -> AltoResult<sys::ALint> {
		ctx.ok_or(AltoError::ExtensionNotPresent)
			.and_then(|ctx| match self {
	...
	pub fn into_raw(self, ctx: Option<&Context>) -> AltoResult<sys::ALint> {
		ctx.ok_or(AltoError::ExtensionNotPresent)
			.and_then(|ctx| match self {
				...
				ExtBFormat::B2DF32 => {
					Ok(ctx.0.exts.AL_EXT_BFORMAT()?.AL_FORMAT_BFORMAT2D_FLOAT32?)
				}
				...
				ExtBFormat::B3DF32 => {
					Ok(ctx.0.exts.AL_EXT_BFORMAT()?.AL_FORMAT_BFORMAT3D_FLOAT32?)
				}
			})
	}
}
...
impl ExtDoubleFormat {
	pub fn into_raw(self, ctx: Option<&Context>) -> AltoResult<sys::ALint> {
		ctx.ok_or(AltoError::ExtensionNotPresent)
			.and_then(|ctx| match self {
				ExtDoubleFormat::Mono => {
					Ok(ctx.0.exts.AL_EXT_double()?.AL_FORMAT_MONO_DOUBLE_EXT?)
				}
				ExtDoubleFormat::Stereo => {
					Ok(ctx.0.exts.AL_EXT_double()?.AL_FORMAT_STEREO_DOUBLE_EXT?)
				}
			})
	}
}
	...
	pub fn into_raw(self, ctx: Option<&Context>) -> AltoResult<sys::ALint> {
		ctx.ok_or(AltoError::ExtensionNotPresent)
			.and_then(|ctx| match self {
				...
				ExtFloat32Format::Stereo => {
					Ok(ctx.0.exts.AL_EXT_float32()?.AL_FORMAT_STEREO_FLOAT32?)
				}
			})
	}
}
	...
	pub fn into_raw(self, ctx: Option<&Context>) -> AltoResult<sys::ALint> {
		ctx.ok_or(AltoError::ExtensionNotPresent)
			.and_then(|ctx| match self {
				...
				ExtMuLawFormat::Stereo => {
					Ok(ctx.0.exts.AL_EXT_MULAW()?.AL_FORMAT_STEREO_MULAW_EXT?)
				}
			})
	}
}
...
impl ExtMuLawBFormat {
	pub fn into_raw(self, ctx: Option<&Context>) -> AltoResult<sys::ALint> {
		ctx.ok_or(AltoError::ExtensionNotPresent)
			.and_then(|ctx| match self {
				ExtMuLawBFormat::B2D => Ok(ctx
					.0
					.exts
					.AL_EXT_MULAW_BFORMAT()?
					.AL_FORMAT_BFORMAT2D_MULAW?),
				ExtMuLawBFormat::B3D => Ok(ctx
					.0
					.exts
					.AL_EXT_MULAW_BFORMAT()?
					.AL_FORMAT_BFORMAT3D_MULAW?),
...
impl ExtMuLawMcFormat {
	pub fn into_raw(self, ctx: Option<&Context>) -> AltoResult<sys::ALint> {
		ctx.ok_or(AltoError::ExtensionNotPresent)
			.and_then(|ctx| match self {
				ExtMuLawMcFormat::Mono => {
					Ok(ctx.0.exts.AL_EXT_MULAW_MCFORMATS()?.AL_FORMAT_MONO_MULAW?)
				}
				ExtMuLawMcFormat::Stereo => Ok(ctx
					.0
					.exts
					.AL_EXT_MULAW_MCFORMATS()?
					.AL_FORMAT_STEREO_MULAW?),
				ExtMuLawMcFormat::Quad => {
					Ok(ctx.0.exts.AL_EXT_MULAW_MCFORMATS()?.AL_FORMAT_QUAD_MULAW?)
				}
				ExtMuLawMcFormat::Rear => {
					Ok(ctx.0.exts.AL_EXT_MULAW_MCFORMATS()?.AL_FORMAT_REAR_MULAW?)
				}
				ExtMuLawMcFormat::Mc51Chn => {
					Ok(ctx.0.exts.AL_EXT_MULAW_MCFORMATS()?.AL_FORMAT_51CHN_MULAW?)
				}
				ExtMuLawMcFormat::Mc61Chn => {
					Ok(ctx.0.exts.AL_EXT_MULAW_MCFORMATS()?.AL_FORMAT_61CHN_MULAW?)
				}
				ExtMuLawMcFormat::Mc71Chn => {
					Ok(ctx.0.exts.AL_EXT_MULAW_MCFORMATS()?.AL_FORMAT_71CHN_MULAW?)
				}
			})
	}
}
...
impl SoftMsadpcmFormat {
	pub fn into_raw(self, ctx: Option<&Context>) -> AltoResult<sys::ALint> {
		ctx.ok_or(AltoError::ExtensionNotPresent)
			.and_then(|ctx| match self {
				SoftMsadpcmFormat::Mono => {
					Ok(ctx.0.exts.AL_SOFT_MSADPCM()?.AL_FORMAT_MONO_MSADPCM_SOFT?)
				}
				SoftMsadpcmFormat::Stereo => Ok(ctx
					.0
					.exts
					.AL_SOFT_MSADPCM()?
					.AL_FORMAT_STEREO_MSADPCM_SOFT?),
...
unsafe impl SampleFrame for Mono<u8> {
	...
	#[inline]
	fn format() -> Format {
		Format::Standard(StandardFormat::MonoU8)
	}
}
unsafe impl SampleFrame for Mono<i16> {
	...
	#[inline]
	fn format() -> Format {
		Format::Standard(StandardFormat::MonoI16)
	}
}
unsafe impl SampleFrame for Mono<f32> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtFloat32(ExtFloat32Format::Mono)
	}
}
unsafe impl SampleFrame for Mono<f64> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtDouble(ExtDoubleFormat::Mono)
	}
}
unsafe impl SampleFrame for Mono<ALawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtALaw(ExtALawFormat::Mono)
	}
}
unsafe impl SampleFrame for Mono<MuLawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMuLaw(ExtMuLawFormat::Mono)
	}
}
...
unsafe impl SampleFrame for Stereo<u8> {
	...
	#[inline]
	fn format() -> Format {
		Format::Standard(StandardFormat::StereoU8)
	}
}
unsafe impl SampleFrame for Stereo<i16> {
	...
	#[inline]
	fn format() -> Format {
		Format::Standard(StandardFormat::StereoI16)
	}
}
unsafe impl SampleFrame for Stereo<f32> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtFloat32(ExtFloat32Format::Stereo)
	}
}
unsafe impl SampleFrame for Stereo<f64> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtDouble(ExtDoubleFormat::Stereo)
	}
}
unsafe impl SampleFrame for Stereo<ALawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtALaw(ExtALawFormat::Stereo)
	}
}
unsafe impl SampleFrame for Stereo<MuLawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMuLaw(ExtMuLawFormat::Stereo)
	}
}
...
unsafe impl SampleFrame for McRear<u8> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::RearU8)
	}
}
unsafe impl SampleFrame for McRear<i16> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::RearI16)
	}
}
unsafe impl SampleFrame for McRear<f32> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::RearF32)
	}
}
unsafe impl SampleFrame for McRear<MuLawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMuLawMcFormats(ExtMuLawMcFormat::Rear)
	}
}
...
unsafe impl SampleFrame for McQuad<u8> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::QuadU8)
	}
}
unsafe impl SampleFrame for McQuad<i16> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::QuadI16)
	}
}
unsafe impl SampleFrame for McQuad<f32> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::QuadF32)
	}
}
unsafe impl SampleFrame for McQuad<MuLawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMuLawMcFormats(ExtMuLawMcFormat::Quad)
	}
}
...
unsafe impl SampleFrame for Mc51Chn<u8> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::Mc51ChnU8)
	}
}
unsafe impl SampleFrame for Mc51Chn<i16> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::Mc51ChnI16)
	}
}
unsafe impl SampleFrame for Mc51Chn<f32> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::Mc51ChnF32)
	}
}
unsafe impl SampleFrame for Mc51Chn<MuLawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMuLawMcFormats(ExtMuLawMcFormat::Mc51Chn)
	}
}
...
unsafe impl SampleFrame for Mc61Chn<u8> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::Mc61ChnU8)
	}
}
unsafe impl SampleFrame for Mc61Chn<i16> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::Mc61ChnI16)
	}
}
unsafe impl SampleFrame for Mc61Chn<f32> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::Mc61ChnF32)
	}
}
unsafe impl SampleFrame for Mc61Chn<MuLawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMuLawMcFormats(ExtMuLawMcFormat::Mc61Chn)
	}
}
...
unsafe impl SampleFrame for Mc71Chn<u8> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::Mc71ChnU8)
	}
}
unsafe impl SampleFrame for Mc71Chn<i16> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::Mc71ChnI16)
	}
}
unsafe impl SampleFrame for Mc71Chn<f32> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMcFormats(ExtMcFormat::Mc71ChnF32)
	}
}
unsafe impl SampleFrame for Mc71Chn<MuLawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMuLawMcFormats(ExtMuLawMcFormat::Mc71Chn)
	}
}
...
unsafe impl SampleFrame for BFormat2D<u8> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtBFormat(ExtBFormat::B2DU8)
	}
}
unsafe impl SampleFrame for BFormat2D<i16> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtBFormat(ExtBFormat::B2DI16)
	}
}
unsafe impl SampleFrame for BFormat2D<f32> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtBFormat(ExtBFormat::B2DF32)
	}
}
unsafe impl SampleFrame for BFormat2D<MuLawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMuLawBFormat(ExtMuLawBFormat::B2D)
	}
}
...
unsafe impl SampleFrame for BFormat3D<u8> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtBFormat(ExtBFormat::B3DU8)
	}
}
unsafe impl SampleFrame for BFormat3D<i16> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtBFormat(ExtBFormat::B3DI16)
	}
}
unsafe impl SampleFrame for BFormat3D<f32> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtBFormat(ExtBFormat::B3DF32)
	}
}
unsafe impl SampleFrame for BFormat3D<MuLawSample> {
	...
	#[inline]
	fn format() -> Format {
		Format::ExtMuLawBFormat(ExtMuLawBFormat::B3D)
	}
}
...
unsafe impl LoopbackFrame for Mono<u8> {
	fn channels(sl: &ext::ALC_SOFT_loopback) -> AltoResult<sys::ALint> {
		Ok(sl.ALC_MONO_SOFT?)
	}
	fn sample_ty(sl: &ext::ALC_SOFT_loopback) -> AltoResult<sys::ALint> {
		Ok(sl.ALC_UNSIGNED_BYTE_SOFT?)
	}
}
...
unsafe impl LoopbackFrame for Mono<f32> {
	...
	fn sample_ty(sl: &ext::ALC_SOFT_loopback) -> AltoResult<sys::ALint> {
		Ok(sl.ALC_FLOAT_SOFT?)
	}
}

unsafe impl LoopbackFrame for Stereo<u8> {
	fn channels(sl: &ext::ALC_SOFT_loopback) -> AltoResult<sys::ALint> {
		Ok(sl.ALC_STEREO_SOFT?)
	}
	fn sample_ty(sl: &ext::ALC_SOFT_loopback) -> AltoResult<sys::ALint> {
		Ok(sl.ALC_UNSIGNED_BYTE_SOFT?)
	}
...
unsafe impl<F> AsBufferData<F> for [F]
where
	F: SampleFrame,
{
	fn as_buffer_data(&self) -> (*const sys::ALvoid, usize) {
...
unsafe impl<F> AsBufferData<F> for [u8]
where
	F: SampleFrame<Sample = u8>,
{
	fn as_buffer_data(&self) -> (*const sys::ALvoid, usize) {
		(self.as_ptr() as *const _, self.len() * mem::size_of::<u8>())
	}
}
unsafe impl<F> AsBufferData<F> for [i16]
where
	F: SampleFrame<Sample = i16>,
{
	fn as_buffer_data(&self) -> (*const sys::ALvoid, usize) {
		(
			self.as_ptr() as *const _,
			self.len() * mem::size_of::<i16>(),
		)
	}
}
unsafe impl<F> AsBufferData<F> for [f32]
where
	F: SampleFrame<Sample = f32>,
{
	fn as_buffer_data(&self) -> (*const sys::ALvoid, usize) {
		(
			self.as_ptr() as *const _,
...
unsafe impl<F, T> AsBufferData<F> for T
where
	F: SampleFrame,
	T: Deref,
...
unsafe impl<F> AsBufferDataMut<F> for [F]
where
	F: SampleFrame,
{
	fn as_buffer_data_mut(&mut self) -> (*mut sys::ALvoid, usize) {
		(
			...
			self.len() * mem::size_of::<F>(),
		)
	}
}
unsafe impl<F> AsBufferDataMut<F> for [u8]
where
	F: SampleFrame<Sample = u8>,
{
	fn as_buffer_data_mut(&mut self) -> (*mut sys::ALvoid, usize) {
...
unsafe impl<F> AsBufferDataMut<F> for [i16]
where
	F: SampleFrame<Sample = i16>,
{
	fn as_buffer_data_mut(&mut self) -> (*mut sys::ALvoid, usize) {
...
unsafe impl<F> AsBufferDataMut<F> for [f32]
where
	F: SampleFrame<Sample = f32>,
{
	fn as_buffer_data_mut(&mut self) -> (*mut sys::ALvoid, usize) {
...
unsafe impl<F, T> AsBufferDataMut<F> for T
where
	F: SampleFrame,
	T: DerefMut,
